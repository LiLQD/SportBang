...
const AddField = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Thêm sân thất bại. Vui lòng kiểm tra lại dữ liệu.');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-2xl font-bold text-gray-800">Thêm sân bóng mới</h1>
      </div>

      {error && (
        <div className="bg-red-50 border-l-4 border-red-500 p-4 text-red-700 text-sm rounded-r-lg shadow-sm">
          {error}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Ví dụ: Sân bóng Mini SportBang"
                />
              </div>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
          ...
          <div className="flex space-x-2">
            <input
              ...
              placeholder="Dán link ảnh tại đây (jpg, png...)"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-4">
            ...
            {formData.images.length === 0 && (
              <div className="col-span-full py-8 text-center bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                ...
                <p className="text-gray-400 text-sm">Chưa có hình ảnh nào được thêm</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
            ...
            <textarea
              ...
              placeholder="Giới thiệu về sân bóng, chất lượng cỏ, ánh sáng..."
            />
          </div>
        ...
        <div className="flex items-center justify-end space-x-4 pt-4">
          ...
          >
            ...
            <span>{saving ? 'Đang tạo...' : 'Tạo sân bóng'}</span>
          </button>
        </div>
      </form>
    </div>
